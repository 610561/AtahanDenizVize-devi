...
public class Rezervasyon
{
    ...
    public Rezervasyon(int id, DateTime tarih, Ucak ucak, Lokasyon nereden, Lokasyon nereye, byte koltukSayisi, bool onay = true)
    {
        Id = id;
        Tarih = tarih;
        Ucak = ucak;
...
public class Program
{
    ...
    {
        Ucak ucak = new Ucak("Boeing 777", "Boeing", "123ABC", 400);
        Lokasyon nereden = new Lokasyon("Türkiye", "İstanbul", "Sabiha Gökçen Havalimanı", Durum.Aktif);
        Lokasyon nereye = new Lokasyon("Türkiye", "Trabzon", "Trabzon Havalimanı", Durum.Aktif);
        DateTime tarih = new DateTime(2023, 8, 26);
        byte koltukSayisi = 2;
